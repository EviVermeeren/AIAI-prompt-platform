...
class User
{
    ...
    //$email->addContent("text/plain", "Hi! Please reset your password. Here is the reset link https://evivermeeren.com/create-new-password.php?token=$token");
    public function sendResetMail($key)
    {
        ...
        $email->addContent("text/plain", "Hi! Please reset your password. Here is the reset link http://evivermeeren.com/php/reset.php?token=$token");
        $email->addContent(
            "text/html",
            "Hi! Please reset your password. <strong>Here is the reset link :</strong> http://evivermeeren.com/php/reset.php?token=$token"
        );
